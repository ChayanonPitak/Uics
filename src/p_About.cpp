...
p_About::p_About(wxWindow* parent) :wxFrame (parent, wxID_ANY, "About", wxPoint(150, 150), wxSize(500, 500))
{
	...
	SpecialText = new wxStaticText(this, wxID_ANY, "630610737", wxPoint(180, 80), wxSize(85, 25));
	...
	SpecialText = new wxStaticText(this, wxID_ANY, "630610724", wxPoint(180, 130), wxSize(85, 25));
	...
	SpecialText = new wxStaticText(this, wxID_ANY, "630610723", wxPoint(180, 180), wxSize(85, 25));
	...
	SpecialText = new wxStaticText(this, wxID_ANY, "630610735", wxPoint(180, 230), wxSize(85, 25));
	...
	SpecialText = new wxStaticText(this, wxID_ANY, "630610741", wxPoint(180, 280), wxSize(85, 25));
